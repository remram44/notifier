...
#ifndef URBANTERROR_H
#define URBANTERROR_H
...
/**
 * Urbanterror server : protocol very similar to GameSpy.
 */
class UrbanterrorServer : public Server {
...
public:
    UrbanterrorServer(const char *host, int port);
    UrbanterrorServer(const QString &param);
